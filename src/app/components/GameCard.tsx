...
const GameCard: React.FC<Props> = ({
  ...
  return (
    <>
      {!finished ? (
        <div className="flex min-h-screen w-4/12 flex-col  bg-customBlue px-10">
          <div className="mb-5 flex h-1/4 w-full justify-center items-center mt-5 relative">
            <div className="absolute top-0 left-0 w-full h-full z-0">
              <Image src="/images/Tempo.png" alt="Imagen" width={750} height={231} />
            </div>
          ...
          <div className="w-full h-auto flex-col justify-center items-center mt-8 relative">
              <Image src="/images/GameCard.png" alt="Imagen de fondo" width={750} height={1000} />
