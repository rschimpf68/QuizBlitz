...
const Main: React.FC<Props> = ({
  ...
  return (
    <div className="flex items-start justify-center h-screen bg-BlueBG overflow-hidden">
      <div className="w-full md:w-4/12 flex flex-col h-full bg-customBlue bg-cover bg-no-repeat bg-center justify-center items-center">
        <Image
